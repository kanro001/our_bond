...
<html lang="en-US">
    <head>
        <meta charset="UTF-8"/>
        <title>OurBond Private Group Page</title>
    ...
    <body>
        ...
        <div class="menu">
                <div id="member_menu">
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="main.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="publicgroups.php">Public Groups</a>&nbsp;&nbsp;&nbsp;&nbsp;<a>Private Groups</a>
...
?>
    ...
    <div>
        <fieldset>
            <legend>Private Group List</legend>
            <?php
